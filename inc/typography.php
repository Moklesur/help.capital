...
function themetim_typography_color($color) {
    ...
    $body_font_family = get_theme_mod( 'body_font_family', 'Lato' );
    ...
    $heading_font_family = get_theme_mod( 'heading_font_family', 'Lato' );
     ...
     * Default Button
     */
    $btn_default_bg = get_theme_mod( 'btn_default_bg', '#fec826' );
    $btn_default_text = get_theme_mod( 'btn_default_text', '#fff' );
    $btn_default_border = get_theme_mod( 'btn_default_border', '#fec826' );
    ...
    $btn_primary_bg_hover = get_theme_mod( 'btn_primary_bg_hover', '#fec826' );
    $btn_primary_text_hover = get_theme_mod( 'btn_primary_text_hover', '#fff' );
    $btn_primary_border_hover = get_theme_mod( 'btn_primary_border_hover', '#fec826' );
